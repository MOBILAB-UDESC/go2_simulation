...
#ifndef GO2_INTERFACES__MSG__DETAIL__IMU_STATE__STRUCT_HPP_
#define GO2_INTERFACES__MSG__DETAIL__IMU_STATE__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__go2_interfaces__msg__IMUState __attribute__((deprecated))
#else
# define DEPRECATED__go2_interfaces__msg__IMUState __declspec(deprecated)
#endif
...
struct IMUState_
{
  ...
  // pointer types
  using RawPtr =
    go2_interfaces::msg::IMUState_<ContainerAllocator> *;
  using ConstRawPtr =
    const go2_interfaces::msg::IMUState_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<go2_interfaces::msg::IMUState_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<go2_interfaces::msg::IMUState_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      go2_interfaces::msg::IMUState_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<go2_interfaces::msg::IMUState_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<go2_interfaces::msg::IMUState_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<go2_interfaces::msg::IMUState_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<go2_interfaces::msg::IMUState_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__go2_interfaces__msg__IMUState
    std::shared_ptr<go2_interfaces::msg::IMUState_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__go2_interfaces__msg__IMUState
    std::shared_ptr<go2_interfaces::msg::IMUState_<ContainerAllocator> const>
...
using IMUState =
  go2_interfaces::msg::IMUState_<std::allocator<void>>;
...
#endif  // GO2_INTERFACES__MSG__DETAIL__IMU_STATE__STRUCT_HPP_
