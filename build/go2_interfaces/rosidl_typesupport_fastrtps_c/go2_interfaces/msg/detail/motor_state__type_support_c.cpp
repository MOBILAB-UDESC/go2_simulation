  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const go2_interfaces__msg__MotorState * ros_message = static_cast<const go2_interfaces__msg__MotorState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_go2_interfaces__msg__MotorState(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  go2_interfaces__msg__MotorState * ros_message = static_cast<go2_interfaces__msg__MotorState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_go2_interfaces__msg__MotorState(cdr, ros_message);
}
