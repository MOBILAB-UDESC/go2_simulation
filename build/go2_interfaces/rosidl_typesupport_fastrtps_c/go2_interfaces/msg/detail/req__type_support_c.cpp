...
bool cdr_serialize_go2_interfaces__msg__Req(
  const go2_interfaces__msg__Req * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_go2_interfaces
bool cdr_deserialize_go2_interfaces__msg__Req(
  eprosima::fastcdr::Cdr & cdr,
  go2_interfaces__msg__Req * ros_message)
{
  // Field name: uuid
  {
    std::string tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_go2_interfaces
bool cdr_serialize_key_go2_interfaces__msg__Req(
  const go2_interfaces__msg__Req * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: uuid
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_go2_interfaces
size_t get_serialized_size_key_go2_interfaces__msg__Req(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Req__ros_msg_type * ros_message = static_cast<const _Req__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_go2_interfaces
size_t max_serialized_size_key_go2_interfaces__msg__Req(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const go2_interfaces__msg__Req * ros_message = static_cast<const go2_interfaces__msg__Req *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_go2_interfaces__msg__Req(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  go2_interfaces__msg__Req * ros_message = static_cast<go2_interfaces__msg__Req *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_go2_interfaces__msg__Req(cdr, ros_message);
}
