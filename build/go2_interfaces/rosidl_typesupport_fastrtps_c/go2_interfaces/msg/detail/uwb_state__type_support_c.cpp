...
bool cdr_serialize_go2_interfaces__msg__UwbState(
  const go2_interfaces__msg__UwbState * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_go2_interfaces
bool cdr_deserialize_go2_interfaces__msg__UwbState(
  eprosima::fastcdr::Cdr & cdr,
  go2_interfaces__msg__UwbState * ros_message)
{
  // Field name: version
  {
    size_t size = 2;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_go2_interfaces
bool cdr_serialize_key_go2_interfaces__msg__UwbState(
  const go2_interfaces__msg__UwbState * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: version
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_go2_interfaces
size_t get_serialized_size_key_go2_interfaces__msg__UwbState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _UwbState__ros_msg_type * ros_message = static_cast<const _UwbState__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_go2_interfaces
size_t max_serialized_size_key_go2_interfaces__msg__UwbState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const go2_interfaces__msg__UwbState * ros_message = static_cast<const go2_interfaces__msg__UwbState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_go2_interfaces__msg__UwbState(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  go2_interfaces__msg__UwbState * ros_message = static_cast<go2_interfaces__msg__UwbState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_go2_interfaces__msg__UwbState(cdr, ros_message);
}
