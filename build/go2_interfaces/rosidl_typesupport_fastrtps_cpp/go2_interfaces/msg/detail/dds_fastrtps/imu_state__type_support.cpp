...
#include "go2_interfaces/msg/detail/imu_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const go2_interfaces::msg::IMUState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  go2_interfaces::msg::IMUState & ros_message)
{
  // Member: quaternion
  {
    cdr >> ros_message.quaternion;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = go2_interfaces::msg::IMUState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const go2_interfaces::msg::IMUState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<go2_interfaces::msg::IMUState *>(
    untyped_ros_message);
...
{
  return &go2_interfaces::msg::typesupport_fastrtps_cpp::_IMUState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, go2_interfaces, msg, IMUState)() {
  return &go2_interfaces::msg::typesupport_fastrtps_cpp::_IMUState__handle;
}
