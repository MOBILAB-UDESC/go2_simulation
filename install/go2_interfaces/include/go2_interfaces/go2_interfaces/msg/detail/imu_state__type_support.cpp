...
{
  new (message_memory) go2_interfaces::msg::IMUState(_init);
}

void IMUState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<go2_interfaces::msg::IMUState *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember IMUState_message_member_array[5] = {
  {
    ...
    offsetof(go2_interfaces::msg::IMUState, quaternion),  // bytes offset in struct
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(go2_interfaces::msg::IMUState, gyroscope),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(go2_interfaces::msg::IMUState, accelerometer),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(go2_interfaces::msg::IMUState, rpy),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(go2_interfaces::msg::IMUState, temperature),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers IMUState_message_members = {
  ...
  5,  // number of fields
  sizeof(go2_interfaces::msg::IMUState),
...
get_message_type_support_handle<go2_interfaces::msg::IMUState>()
{
  return &::go2_interfaces::msg::rosidl_typesupport_introspection_cpp::IMUState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, go2_interfaces, msg, IMUState)() {
  return &::go2_interfaces::msg::rosidl_typesupport_introspection_cpp::IMUState_message_type_support_handle;
}
