...
bool go2_interfaces__msg__sport_mode_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // imu_state
    ...
    if (!go2_interfaces__msg__imu_state__convert_from_py(field, &ros_message->imu_state)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * go2_interfaces__msg__sport_mode_state__convert_to_py(void * raw_ros_message)
{
  ...
  {  // imu_state
    PyObject * field = NULL;
    field = go2_interfaces__msg__imu_state__convert_to_py(&ros_message->imu_state);
    if (!field) {
      return NULL;
    }
    {
