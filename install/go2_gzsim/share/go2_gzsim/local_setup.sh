...
: ${AMENT_CURRENT_PREFIX:="/home/samsung/go2_ws/src/go2_simulation/install/go2_gzsim"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/go2_gzsim/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/go2_gzsim/environment/path.sh"
